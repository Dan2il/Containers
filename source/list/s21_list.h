...
class list {
 ...
 private:
  ...
  void DelLink(Node<Type>* node);

  Node<Type>* CreateTree();
  void PushNodeTree(Node<Type>* step, Node<Type>* head);
...
typename s21::list<Type>::iterator s21::list<Type>::insert(iterator pos,
  ...
  if (!stored_) {
    LinkPointerNodeRange(end_node_, end_node_, new_node, new_node);
...
template <typename Type>
void s21::list<Type>::PushNodeTree(Node<Type>* step, Node<Type>* head) {
...
template <typename Type>
void s21::list<Type>::DelLink(Node<Type>* node) {
